            ...
            <div class="card-body p-5">
              ...
              <form action="userRegister" method="post">
                ...
                <div class="form-outline mb-4">
                  ...
                  <label class="form-label" for="form3Example4cg">User Password</label>
                </div>
				...
				<div class="form-outline mb-4">
                  ...
                  <label class="form-label" for="form3Example4cg">Repeate Password</label>
                </div>
                ...
                <p class="text-center text-muted mt-5 mb-0">Have already an account? <a href="user-login-form.jsp"
